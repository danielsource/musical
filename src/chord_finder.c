...
const Chord chords[LANGUAGE_LAST][LENGTH(*chords)] = {
    [PORTUGUESE] = {
        ...
        {"4-3-4",   "maior com sétima maior", 0},
        ...
        {"4-3-3",   "maior com sétima dominante", 0},
        ...
        {"3-4-4",   "menor-maior com sétima", 0},
        ...
        {"2-2-3",   "maior com nona adicionada", 0},
        ...
        {"4-3-4-3", "maior com nona dominante", 0},
